...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        // Section for PHP code that displays all invoice data based on a invoice Number  ///
...
///////////////////////////////////////////////////////////////////////////////////////
    ?>
       ...
       <!--------------------------     Update Button  -------------------------------------->
        ...
        <div class = "Tmenu">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                <label for="table">Select a Invoice Table To View:</label>
                <select name="table" id="table">
                    <?php
                        $tables = $conn->query(
                        "SELECT DISTINCT TABLE_NAME
                        FROM INFORMATION_SCHEMA.COLUMNS
                        WHERE COLUMN_NAME = 'invoiceNbr';");
